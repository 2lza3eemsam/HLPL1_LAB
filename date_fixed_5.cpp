...
// Function to add or subtract days from a Date
{
    ...
    if (d > 31) { ++n_m; d -= 31; }     // Day plus = +1 month
    if (d < 1)  { --n_m; d += 31; }     // Day minus = -1 month
...
// Function to add or subtract month from a Date.
{
...
// Function to add or subtract from a date.
{
    y += n;
}
